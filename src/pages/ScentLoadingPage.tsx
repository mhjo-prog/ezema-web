...
const steps = [
  { label: "생활 패턴 분석 중", en: "Analyzing lifestyle pattern" },
  { label: "필요한 향 매칭 중", en: "Matching your scent needs" },
  { label: "맞춤 결과 생성 중", en: "Generating personalized result" },
];

export default function ScentLoadingPage({ onComplete }: Props) {
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ height: "3px", background: `linear-gradient(90deg, ${ACCENT}, ${ACCENT_LIGHT})` }}
      />
