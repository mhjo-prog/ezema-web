                  ...
                  <div style={{ flex: 1, minHeight: 0 }}>
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={chartData} margin={{ top: 4, right: 8, left: -20, bottom: 0 }}>
                        ...
                        <Line type="monotone" dataKey="visits" name="방문자" stroke="#000000" strokeWidth={2} dot={{ r: 3, fill: "#ffffff", stroke: "#000000", strokeWidth: 2 }} />
                        <Line type="monotone" dataKey="quizCompletes" name="진단완료(사상체질)" stroke="#999999" strokeWidth={2} dot={{ r: 3, fill: "#ffffff", stroke: "#999999", strokeWidth: 2 }} />
                        <Line type="monotone" dataKey="scentCompletes" name="진단완료(향)" stroke="#cccccc" strokeWidth={2} dot={{ r: 3, fill: "#ffffff", stroke: "#cccccc", strokeWidth: 2 }} />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                </div>
