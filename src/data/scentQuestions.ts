...
export const scentQuestions: ScentQuestion[] = [
  { id: 1, category: "수면 패턴", text: "잠자리에 누운 뒤 잠들기까지\n보통 얼마나 걸리나요?", facet: "onset", options: [
    { id: "a", text: "10분 이내", scores: s("숙면", 4) },
    { id: "b", text: "10~20분", scores: s("숙면", 3) },
    { id: "c", text: "20~40분", scores: s("숙면", 2) },
    { id: "d", text: "40분 이상", scores: s("숙면", 1) },
  ]},
  { id: 2, category: "수면 패턴", text: "자다가 중간에 깨는 일이\n얼마나 잦나요?", facet: "maintain", options: [
    { id: "a", text: "거의 없다", scores: s("숙면", 4) },
    { id: "b", text: "주 1~2회", scores: s("숙면", 3) },
    { id: "c", text: "주 3~4회", scores: s("숙면", 2) },
    { id: "d", text: "거의 매일", scores: s("숙면", 1) },
  ]},
  { id: 3, category: "수면 패턴", text: "아침에 눈을 떴을 때\n개운한 느낌이 드나요?", facet: "morning", options: [
    { id: "a", text: "항상 개운하다", scores: s("숙면", 4) },
    { id: "b", text: "대체로 개운한 편이다", scores: s("숙면", 3) },
    { id: "c", text: "대체로 찌뿌둥하다", scores: s("숙면", 2) },
    { id: "d", text: "항상 피곤하게 느껴진다", scores: s("숙면", 1) },
  ]},
  { id: 4, category: "수면 패턴", text: "최근 한 달간 수면 시간이\n불규칙했던 날이 얼마나 되나요?", facet: "rhythm", options: [
    { id: "a", text: "거의 없다", scores: s("숙면", 4) },
    { id: "b", text: "주 1~2일", scores: s("숙면", 3) },
    { id: "c", text: "주 3~4일", scores: s("숙면", 2) },
    { id: "d", text: "거의 매일", scores: s("숙면", 1) },
  ]},
  { id: 5, category: "스트레스 · 긴장", text: "최근 일주일, 사소한 일에도\n예민하거나 짜증이 난 적이 있나요?", facet: "emotional", options: [
    { id: "a", text: "전혀 없다", scores: s("이완", 4) },
    { id: "b", text: "가끔", scores: s("이완", 3) },
    { id: "c", text: "자주", scores: s("이완", 2) },
    { id: "d", text: "거의 매일", scores: s("이완", 1) },
  ]},
  { id: 6, category: "스트레스 · 긴장", text: "어깨나 목이 뻐근하거나 긴장되어\n있다고 느끼는 날이 얼마나 되나요?", facet: "physical", options: [
    { id: "a", text: "거의 없다", scores: s("이완", 4) },
    { id: "b", text: "주 1~2일", scores: s("이완", 3) },
    { id: "c", text: "주 3~4일", scores: s("이완", 2) },
    { id: "d", text: "거의 매일", scores: s("이완", 1) },
  ]},
  { id: 7, category: "스트레스 · 긴장", text: "심장이 이유 없이 두근거리거나\n숨이 답답하게 느껴진 적이 있나요?", facet: "autonomic", options: [
    { id: "a", text: "전혀 없다", scores: s("이완", 4) },
    { id: "b", text: "가끔 있다", scores: s("이완", 3) },
    { id: "c", text: "자주 있다", scores: s("이완", 2) },
    { id: "d", text: "매우 자주 있다", scores: s("이완", 1) },
  ]},
  { id: 8, category: "스트레스 · 긴장", text: "하루를 마치고 나서 완전히\n긴장이 풀렸다는 느낌을 받나요?", facet: "recovery", options: [
    { id: "a", text: "항상 그렇다", scores: s("이완", 4) },
    { id: "b", text: "대체로 그렇다", scores: s("이완", 3) },
    { id: "c", text: "잘 그렇지 않다", scores: s("이완", 2) },
    { id: "d", text: "거의 그런 적이 없다", scores: s("이완", 1) },
  ]},
  { id: 9, category: "활동량 · 피로도", text: "오후 2~4시 사이 집중력이나\n에너지가 급격히 떨어지나요?", facet: "afternoon", options: [
  ...
  { id: 10, category: "활동량 · 피로도", text: "아침에 눈을 뜨는 것 자체가\n힘들게 느껴지나요?", facet: "wakeup", options: [
    { id: "a", text: "전혀 아니다", scores: s("활력", 4) },
    { id: "b", text: "가끔", scores: s("활력", 3) },
    { id: "c", text: "자주", scores: s("활력", 2) },
    { id: "d", text: "거의 매일", scores: s("활력", 1) },
  ]},
  { id: 11, category: "활동량 · 피로도", text: "특별히 무리하지 않았는데도\n몸이 무겁게 느껴지는 날이 있나요?", facet: "fatigue", options: [
    { id: "a", text: "거의 없다", scores: s("활력", 4) },
    { id: "b", text: "주 1~2일", scores: s("활력", 3) },
    { id: "c", text: "주 3~4일", scores: s("활력", 2) },
    { id: "d", text: "거의 매일", scores: s("활력", 1) },
  ]},
  { id: 12, category: "활동량 · 피로도", text: "평소 카페인(커피 등)에 의존해\n하루를 버틴다고 느끼나요?", facet: "caffeine", options: [
    { id: "a", text: "전혀 아니다", scores: s("활력", 4) },
    { id: "b", text: "약간 그렇다", scores: s("활력", 3) },
    { id: "c", text: "꽤 그렇다", scores: s("활력", 2) },
    { id: "d", text: "카페인 없이는 힘들다", scores: s("활력", 1) },
  ]},
  { id: 13, category: "집중 · 업무환경", text: "한 가지 작업에 방해 없이\n집중할 수 있는 시간은 얼마나 되나요?", facet: "duration", options: [
  ...
  { id: 14, category: "집중 · 업무환경", text: "일하는 동안 스마트폰&다른 생각으로\n흐름이 끊기는 일이 얼마나 되나요?", facet: "distract", options: [
    { id: "a", text: "거의 없다", scores: s("몰입", 4) },
    { id: "b", text: "가끔", scores: s("몰입", 3) },
    { id: "c", text: "자주", scores: s("몰입", 2) },
    { id: "d", text: "매우 자주", scores: s("몰입", 1) },
  ]},
  { id: 15, category: "집중 · 업무환경", text: "여러 가지 일을 동시에 처리해야 하는\n상황이 얼마나 되나요?", facet: "switch", options: [
    { id: "a", text: "거의 없다", scores: s("몰입", 4) },
    { id: "b", text: "가끔", scores: s("몰입", 3) },
    { id: "c", text: "자주", scores: s("몰입", 2) },
    { id: "d", text: "항상 그렇다", scores: s("몰입", 1) },
  ]},
  { id: 16, category: "집중 · 업무환경", text: "하루 중 화면(모니터&스마트폰)을\n보는 시간은 대략 얼마나 되나요?", facet: "screen", options: [
    { id: "a", text: "4시간 미만", scores: s("몰입", 4) },
    { id: "b", text: "4~7시간", scores: s("몰입", 3) },
    { id: "c", text: "7~10시간", scores: s("몰입", 2) },
    { id: "d", text: "10시간 이상", scores: s("몰입", 1) },
  ]},
  { id: 17, category: "실내환경 · 호흡기", text: "하루 중 창문을 열어\n환기하는 횟수는 얼마나 되나요?", facet: "hygiene", options: [
    { id: "a", text: "3회 이상", scores: s("청정", 4) },
    { id: "b", text: "1~2회", scores: s("청정", 3) },
    { id: "c", text: "거의 안 한다", scores: s("청정", 2) },
    { id: "d", text: "전혀 안 한다", scores: s("청정", 1) },
  ]},
  { id: 18, category: "실내환경 · 호흡기", text: "미세먼지가 심한 날, 컨디션이나\n목 상태가 눈에 띄게 나빠지나요?", facet: "sensitive", options: [
    { id: "a", text: "전혀 아니다", scores: s("청정", 4) },
    { id: "b", text: "약간 그렇다", scores: s("청정", 3) },
    { id: "c", text: "꽤 그렇다", scores: s("청정", 2) },
    { id: "d", text: "매우 그렇다", scores: s("청정", 1) },
  ]},
  { id: 19, category: "실내환경 · 호흡기", text: "코막힘, 목 간지러움 등 가벼운\n호흡기 불편을 느끼는 빈도는?", facet: "airway", options: [
    { id: "a", text: "거의 없다", scores: s("청정", 4) },
    { id: "b", text: "가끔", scores: s("청정", 3) },
    { id: "c", text: "자주", scores: s("청정", 2) },
    { id: "d", text: "거의 매일", scores: s("청정", 1) },
  ]},
  { id: 20, category: "실내환경 · 호흡기", text: "실내(사무실·집)에서 공기가\n답답하거나 탁하다고 느끼 빈도는?", facet: "stuffy", options: [
    { id: "a", text: "거의 없다", scores: s("청정", 4) },
    { id: "b", text: "가끔", scores: s("청정", 3) },
    { id: "c", text: "자주", scores: s("청정", 2) },
