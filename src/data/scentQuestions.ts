...
export const scentQuestions: ScentQuestion[] = [
  ...
  { id: 9, category: "활동량 · 피로도", text: "어제 오후 2~4시 사이 집중력이나\n에너지가 급격히 떨어졌나요?", facet: "afternoon", options: [
  ...
  { id: 10, category: "활동량 · 피로도", text: "어제 아침에 눈을 뜨는 것 자체가\n힘들게 느껴졌나요?", facet: "wakeup", options: [
    { id: "a", text: "전혀 아니다", scores: s("활력", 4) },
  ...
  { id: 18, category: "실내환경 · 호흡기", text: "최근 일주일 동안 미세먼지가 심한 날\n컨디션이나 목 상태가 눈에 띄게 나빠졌나요?", facet: "sensitive", options: [
